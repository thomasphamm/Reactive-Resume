...
import { basicsSchema, defaultSections } from "@reactive-resume/schema";
import { Input, Label, RichInput } from "@reactive-resume/ui";
  ...
  return (
    <section id="basics" className="grid gap-y-6">
      ...
      <main className="grid gap-4 sm:grid-cols-2">
        ...
        <section id="summary" className="grid gap-y-6 space-y-1.5 sm:col-span-2">
          <header className="flex items-center justify-between">
            <div className="flex items-center gap-x-4">
